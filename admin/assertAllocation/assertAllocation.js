...
async function loadAssets() {
    try {
        const response = await fetch("https://api.theoppty.com/api/assets/");
        if (response.ok) {
...
async function loadReturnAssets() {
    try {
        const response = await fetch("https://api.theoppty.com/api/return-assets/");
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if(confirm("Are you sure you want to delete this asset?")) {
        ...
        const response = await fetch(`https://api.theoppty.com/api/assets/${dbId}/`,{
            method:"DELETE"
        });
...
if (button.classList.contains('hra-return-confirm-btn')) {
    ...
    const response = await fetch(`https://api.theoppty.com/api/return-status/${returnId}/`, {
        method: "PATCH",
        headers: {
...
if (button.classList.contains('hra-return-reject-btn')) {
    ...
    if(confirm("Delete this return record?")) {
        ...
        const response = await fetch(`https://api.theoppty.com/api/return-assets/${returnId}/`,{
            method:"DELETE"
        });
