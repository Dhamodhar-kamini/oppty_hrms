        ...
        <body>
            ...
            <div id="payslipElement" class="payslip-container">
                <header class="main-header">
                    ...
                    <div class="company-info"><h1>Oppty Techhub Private Limited</h1><p>3rd Floor, Plot No-474, SSNA Park, Shanti Sree,<br>Ameenpur, Medak - 502032, Telangana</p></div>
                ...
                <div class="section-container red-border">
                    ...
                    <table><thead><tr><th>Deductions</th><th style="text-align:right">Monthly</th></tr></thead><tbody>
                        ...
                        <tr><td>Professional Tax</td><td class="amount">₹${formatCurrency(professionalTax)}</td></tr><tr class="total-row"><td>Total Deductions</td><td class="amount">₹${formatCurrency(deductions)}</td></tr>
                    </tbody></table>
                </div>
